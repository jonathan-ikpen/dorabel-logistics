    ...
    cms.events.subscribe("cms:enable", () => {
      if (typeof document !== "undefined") {
        ...
        const injectSidebarLinks = () => {
          ...
          if (!sidebarList || document.getElementById("tina-custom-analytics-link"))
            return;
          const customLinks = [
            {
          ...
          customLinks.forEach((linkConfig) => {
            ...
            a.className = "text-base tracking-wide text-gray-500 hover:text-blue-600 flex items-center opacity-90 hover:opacity-100 cursor-pointer";
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            description: "Find this in Tawk.to Dashboard > Administration > Channels > Chat Widget"
          },
          {
            type: "object",
            label: "Header",
